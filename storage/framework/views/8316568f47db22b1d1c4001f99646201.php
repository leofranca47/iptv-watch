            ...
            <div x-show="sidebarVisible" x-transition class="flex-1 overflow-y-auto">
                <div class="p-3 space-y-2">
                    <div class="flex gap-1">
                        <button
                            ...
                            class="flex-1 px-3 py-2 text-sm rounded-lg transition <?php echo e($selectedTab === 'canais' ? 'bg-blue-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'); ?>"
                        >
                            Canais
                        </button>
                        <button
                            wire:click="setTab('filmes')"
                            class="flex-1 px-3 py-2 text-sm rounded-lg transition <?php echo e($selectedTab === 'filmes' ? 'bg-blue-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'); ?>"
                        >
                            Filmes
                        </button>
                    </div>
                ...
                <div class="px-2 pb-3 space-y-1">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->allChannels->isEmpty()): ?>
                        <p class="text-center text-gray-400 text-sm py-4">Nenhum <?php echo e($selectedTab === 'filmes' ? 'filme' : 'canal'); ?> encontrado</p>
                    <?php elseif($this->hasMoreChannels): ?>
                        <button
                            wire:click="channelPage = channelPage + 1"
                            class="w-full py-2 text-sm text-blue-400 hover:text-blue-300"
                        >
                            Carregar mais (<?php echo e($this->totalChannels - ($this->channelPage * $this->perPage)); ?> restantes)
                        </button>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        ...
        <main class="flex-1 flex flex-col overflow-hidden">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedChannel): ?>
                <div class="px-4 pb-2 flex justify-center">
                    <button
                        onclick="window.open('vlc://' + encodeURIComponent('<?php echo e($selectedChannel->stream_url); ?>'), '_self')"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isImporting): ?>
                <div class="p-4 bg-gray-800 border-t border-gray-700" wire:poll.200ms="pollProgress">
                    <div class="flex items-center gap-4 mb-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($importProgress['current_logo']): ?>
                            <img src="<?php echo e($importProgress['current_logo']); ?>" class="w-10 h-10 object-contain rounded bg-gray-700">
                        <?php else: ?>
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div class="flex-1">
                            <p class="text-sm text-white font-medium"><?php echo e($importProgress['current_channel']); ?></p>
                            <p class="text-xs text-gray-400"><?php echo e($importProgress['processed']); ?> / <?php echo e($importProgress['total']); ?> (<?php echo e($importProgress['percentage']); ?>%)</p>
                        </div>
                    </div>
                    <div class="w-full bg-gray-700 rounded-full h-2">
                        <div
                            class="bg-blue-500 h-2 rounded-full transition-all duration-300"
                            style="width: <?php echo e($importProgress['percentage']); ?>%"
                        ></div>
                    </div>
                </div>
            <?php elseif($selectedChannel && count($channelPrograms) > 0): ?>
                <div class="flex-1 overflow-y-auto p-4 bg-white dark:bg-gray-800">
                    <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">
                        Programação - <?php echo e($selectedChannel->name); ?>

                    </h3>
                    <div class="space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $channelPrograms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="flex gap-4 p-3 bg-gray-100 dark:bg-gray-700 rounded-lg">
                                <div class="text-center min-w-[60px]">
                                    <p class="text-sm font-medium text-blue-600 dark:text-blue-400">
                                        <?php echo e(\Carbon\Carbon::parse($program['start_time'])->format('H:i')); ?>

                                    </p>
                                    <p class="text-xs text-gray-500">
                                        <?php echo e(\Carbon\Carbon::parse($program['end_time'])->format('H:i')); ?>

                                    </p>
                                </div>
                                <div class="flex-1">
                                    <p class="font-medium text-gray-900 dark:text-white"><?php echo e($program['title']); ?></p>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($program['description']): ?>
                                        <p class="text-sm text-gray-500 mt-1"><?php echo e(Str::limit($program['description'], 100)); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
