<div>
    ...
    @elseif ($status === 'loading' && $streamUrl)
        <div class="space-y-2">
            <div class="aspect-video bg-gray-800 flex items-center justify-center rounded-lg">
                <div class="text-center text-gray-400">
            ...
            <div class="flex justify-center">
                <button
                    onclick="window.open('vlc://' + encodeURIComponent('{{ $streamUrl }}'), '_self')"
    ...
    @elseif ($status === 'error')
        <div class="aspect-video bg-gray-800 flex items-center justify-center rounded-lg">
            <div class="text-center text-red-400">
                ...
                <button
                    onclick="window.open('vlc://' + encodeURIComponent('{{ $streamUrl ?? '' }}'), '_self')"
                    class="px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg transition inline-flex items-center gap-2"
                >
